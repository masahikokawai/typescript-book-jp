...
どのSymbolTableに登録されるかは、この関数の最初の引数によって決まります。例えば`SyntaxKind.ClassDeclaration`または`SyntaxKind.ClassExpression`の_container_にdeclarationを追加するときに、以下にコードを示す`declareClassMember`関数が呼び出されます:

...
* `tsc -p ./path-to-project-directory`を実行します。もちろん、パスは現在のディレクトリに対して絶対パスでも相対パスでもかまいません

tsc -wを使って_watch_モードでTypeScriptコンパイラを起動することもでき、TypeScriptプロジェクトファイルの変更を監視します。
